...
public class MainScreen extends ScreenAdapter {
    ...
    public void show() {
        ...
        backgroundTexture = gameManager.assetManager.get("leaguebackground.png");
    ...
    public void render(float delta) {
        ...
        gameManager.spriteBatch.draw(backgroundTexture, 0, 0, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
